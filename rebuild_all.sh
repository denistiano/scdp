...
echo -e "${YELLOW}[3/4] Crawling scdp.bg/booking...${NC}"
./crawl_booking_site.sh
echo ""

# Step 4: Build the website
echo -e "${YELLOW}[4/4] Building website...${NC}"
